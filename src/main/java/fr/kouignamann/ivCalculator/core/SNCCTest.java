...
public class SNCCTest {
    ...
    public static void main(String[] args) {
        BufferedImage image = Capture.load(OCRTest.class, "resources/desktop.png");
        BufferedImage template = Capture.load(OCRTest.class, "resources/desktop_feature_big.png");
